...
"arb": { name:"Arabic, Standard", local:"العَرَبِيَّة‎", localtrans:"[alʕaraˈbijja]", silcode:"", rtl:true, scriptname:"ألأبجدية ٱلعربية‎", scriptnametrans:"ʔalʔabd͡ʒadiːjaʰ lʕarabiːjaʰ‎", 
...
"arab": {name:"Arabic [arb]", region:"wasia", type:"abjad", 
blocks:7, chars:449, bletter:276, bmark:118, bnumber:20, bpunctuation:0, bsymbol:11, bother:11, 
direction:"rtl", rtlnumbers:N,
voweltype: { inherent:0, letters:Y, marks:Y, hidden:Y, visorder:N, vocalics:N, ivowels:N, vbase:"Aleph ا", vcomposite:Y, prebase:N, circum:N, },
