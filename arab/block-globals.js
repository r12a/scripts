...
window.languageList = ['ar','pes','ha','ks','ug','ur','ff'] // lang tags for each orthography handled
window.detailsfileList = ['arb','pes','ha','ks','ug','ur','ff','misc'] // first part of xx-details for each orthography
