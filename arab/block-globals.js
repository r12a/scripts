...
window.languageList = ['ar','pes','ha','ks','ug','ur'] // lang tags for each orthography handled
window.detailsfileList = ['arb','pes','ha','ks','ug','ur','misc'] // first part of xx-details for each orthography
