...
orthogFilePath='arab/ks'  // path below /scripts, including filename, but no extension, eg. lana/nod
pickerDir='arab-ks'  // directory name for picker, no slash at end
orthogSummaryTableName='ks'  // id used for langs record in xx-langdata.js; used to make summary table
