...
"j": {
"authors": "Jack Smart and Francis Altorfer",
"title":"Teach Yourself Arabic",
"publisher":"Oxford University Press",
"isbn":"978-0-340-86996-3",
"lang": new Set(['ar','ur']),
"reviewed":true
},
...
"authors": "Wikipedia",
"title":"Arabic script",
"url":"http://en.wikipedia.org/wiki/Arabic_script",
"lang": new Set(['ar']),
},
...
"abv":{name:"Arabic, Baharna"},
"bqi":{name:"Bakhtiari"},
"sse":{name:"Balangingi"},
"bjt":{name:"Balanta-Ganja"},
"bft":{name:"Balti"},
"bal":{name:"Baluchi"},
"bjn":{name:"Banjar"},
"bej":{name:"Bedawiyet"},
...
"knc":{name:"Kanuri, Central"},
"ckb":{name:"Kurdish, Central"},
"pst":{name:"Pashto, Central", url:"ps.html" },
"shu":{name:"Arabic, Chadian"},
...
"sce":{name:"Dongxiang"},
"dyu":{name:"Dyula"},
"bgp":{name:"Balochi, Eastern"},
"cjm":{name:"Cham, Eastern"},
"avl":{name:"Arabic, Eastern Egyptian Bedawi"},
"emk":{name:"Maninkakan, Eastern"},
"arz":{name:"Arabic, Egyptian"},
"ful":{name:"Fulah"},
"gzi":{name:"Gazi"},
"glk":{name:"Gilaki"},
"gig":{name:"Goaria"},
"gwf":{name:"Gowro"},
"gju":{name:"Gujari"},
"afb":{name:"Arabic, Gulf"},
"hac":{name:"Gurani"},
"ggg":{name:"Gurgula"},
"hrz":{name:"Harzani"},
"mey":{name:"Hassaniyya"},
"hau":{name:"Hausa", url:"ha.html"},
"haz":{name:"Hazaragi"},
"acw":{name:"Arabic, Hijazi"},
"dbj":{name:"Ida'an"},
"ind":{name:"Indonesian"},
"mvy":{name:"Kohistani, Indus"},
"inh":{name:"Ingush"},
"pes":{name:"Persian, Iranian", url:"pes.html"},
"jdg":{name:"Jadgali"},
"jad":{name:"Jahanka"},
"bze":{name:"Bozo, Jenaama"},
"dyo":{name:"Jola-Fonyi"},
...
"kaz":{name:"Kazakh"},
"xnz":{name:"Kenzi"},
"kmz":{name:"Khorasani Turkish"},
"khw":{name:"Khowar"},
"kfm":{name:"Khunsari"},
"plk":{name:"Shina, Kohistani"},
"eko":{name:"Koti"},
"kum":{name:"Kumyk"},
"kur":{name:"Kurdish"},
"kir":{name:"Kyrgyz"},
...
"lrl":{name:"Lari"},
"lsa":{name:"Lasgerdi"},
"ayl":{name:"Arabic, Libyan"},
"ffm":{name:"Fulfulde, Maasina"},
"mde":{name:"Maba (Chad)"},
"zlm":{name:"Malay (individual language)"},
"msa":{name:"Malay (macrolanguage)"},
"mal":{name:"Malayalam"},
"mlt":{name:"Maltese"},
"man":{name:"Mandingo"},
"mnk":{name:"Mandinka"},
"kby":{name:"Kanuri, Manga"},
"swb":{name:"Comorian, Maore"},
"mve":{name:"Marwari (Pakistan)"},
"mzn":{name:"Mazanderani"},
"acm":{name:"Arabic, Mesopotamian"},
"mfg":{name:"Mogofin"},
"ary":{name:"Arabic, Moroccan"},
"mnj":{name:"Munji"},
"wmw":{name:"Mwani"},
"jbn":{name:"Nafusi"},
"ars":{name:"Arabic, Najdi"},
"ntz":{name:"Natanzi"},
"nyq":{name:"Nayini"},
"wni":{name:"Comorian, Ndzwani"},
"zdj":{name:"Comorian, Ngazidja"},
"fuv":{name:"Fulfulde, Nigerian"},
"fia":{name:"Nobiin"},
"azj":{name:"Azerbaijani, North"},
"apc":{name:"Arabic, North Levantine"},
"ayp":{name:"Arabic, North Mesopotamian"},
"hno":{name:"Hindko, Northern"},
"kmr":{name:"Kurdish, Northern"},
"lrc":{name:"Luri, Northern"},
"pbu":{name:"Pashto, Northern", url:"ps.html" },
"uzn":{name:"Uzbek, Northern"},
"faz":{name:"Fars, Northwestern"},
"odk":{name:"Od"},
"acx":{name:"Arabic, Omani"},
"oru":{name:"Ormuri"},
"ota":{name:"Turkish, Ottoman (1500-1928)"},
"phr":{name:"Pahari-Potwari"},
"phl":{name:"Palula"},
"pan":{name:"Panjabi"},
"kvx":{name:"Koli, Parkari"},
"prd":{name:"Parsi-Dari"},
...
"rhg":{name:"Rohingya"},
"rdb":{name:"Rudbari"},
"sav":{name:"Saafi-Saafi"},
"aec":{name:"Arabic, Saidi"},
"smp":{name:"Samaritan"},
"ayn":{name:"Arabic, Sanaani"},
"sgr":{name:"Sangisari"},
"skr":{name:"Saraiki", url:"skr.html" },
"smy":{name:"Semnani"},
"srr":{name:"Serer"},
"shm":{name:"Shahrudi"},
"scl":{name:"Shina"},
"sgh":{name:"Shughni"},
"snd":{name:"Sindhi", url:"sd.html" },
"som":{name:"Somali"},
"snk":{name:"Soninke"},
"sqt":{name:"Soqotri"},
"azb":{name:"Azerbaijani, South"},
"ajp":{name:"Arabic, South Levantine"},
"psi":{name:"Pashai, Southeast"},
"bcc":{name:"Balochi, Southern"},
"hnd":{name:"Hindko, Southern"},
"sdh":{name:"Kurdish, Southern"},
"luz":{name:"Luri, Southern"},
"pbt":{name:"Pashto, Southern", url:"ps.html"},
"uzs":{name:"Uzbek, Southern"},
"fay":{name:"Fars, Southwestern"},
"arb":{name:"Arabic, Standard ", url:"arb.html"},
"zsm":{name:"Malay, Standard"},
"apd":{name:"Arabic, Sudanese"},
"sun":{name:"Sundanese"},
"sus":{name:"Susu"},
"swa":{name:"Swahili (macrolanguage)"},
"acq":{name:"Arabic, Ta'izzi-Adeni"},
"shy":{name:"Tachawit"},
"shi":{name:"Tachelhit"},
"dsq":{name:"Tadaksahak"},
"tda":{name:"Tagdal"},
...
"kdh":{name:"Tem"},
"boz":{name:"Bozo, Tiéyaxo"},
"trw":{name:"Torwali"},
"mzb":{name:"Tumzabt"},
"aeb":{name:"Arabic, Tunisian"},
"tur":{name:"Turkish"},
"tuk":{name:"Turkmen"},
"urd":{name:"Urdu", url:"ur.html"},
"uig":{name:"Uyghur", url:"ug.html"},
"uzb":{name:"Uzbek"},
"vaf":{name:"Vafsi"},
"kxp":{name:"Koli, Wadiyara"},
"wbl":{name:"Wakhi"},
"bgn":{name:"Balochi, Western"},
"cja":{name:"Cham, Western"},
"mlq":{name:"Maninkakan, Western"},
"fuh":{name:"Fulfulde, Western Niger"},
"pnb":{name:"Panjabi, Western"},
"wlo":{name:"Wolio"},
"wol":{name:"Wolof"},
"yka":{name:"Yakan"},
"yal":{name:"Yalunka"},
...
"f": {
"url":"https://www.freearabicdictionary.com/",
"authors": "FreeArabicDictionary",
"title":"Arabic Dictionary & Translation",
"lang": new Set(['ar']),
},
