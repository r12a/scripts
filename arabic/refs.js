...
"inh":{name:"Ingush"},
"pes":{name:"Persian, Iranian", url:"arab-fa.html"},
"jdg":{name:"Jadgali"},
"jad":{name:"Jahanka"},
...
"gwc":{name:"Kalami"},
"kls":{name:"Kalasha"},
"kas":{name:"Kashmiri", url:"kashmiri.html"},
"bsh":{name:"Kati"},
"kaz":{name:"Kazakh"},
"xnz":{name:"Kenzi"},
...
"pbt":{name:"Pashto, Southern"},
"uzs":{name:"Uzbek, Southern"},
"fay":{name:"Fars, Southwestern"},
"arb":{name:"Arabic, Standard ", url:"index.html"},
...
"tur":{name:"Turkish"},
"tuk":{name:"Turkmen"},
"urd":{name:"Urdu", url:"urdu.html"},
"uig":{name:"Uyghur", url:"uighur.html"},
"uzb":{name:"Uzbek"},
"vaf":{name:"Vafsi"},
