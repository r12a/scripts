...
`
out += `
        <p><span class="leadin">Transcriptions &amp; transliterations.</span> Phonological transcriptions vary between broad to narrow <span class="ipa narrow">phonetic</span>, and <span class="phoneme narrow">phonemic</span> transcriptions, depending on what is available in the sources.
        <a href="../glossary/index.html#transcription" class="termref">Transcriptions</a> between <span class="transc">angle brackets</span>, represent the letters as commonly written in the native script.<br><br>
        A <em><a href="../glossary/index.html#transliteration" class="termref">transliteration scheme</a></em> has also been developed especially for this orthography, and is generally based on the sound of a letter where possible, but where a letter has multiple pronunciations, the transliteration represents only one. 
        ...
        When you click on an example to see its composition, the top of the panel that opens contains a transliteration, with the native text below, and then below that (if available) an IPA transcription.</p>
...
<p><a target="_blank" href="index.html#languages">Languages using the ${ script } script</a> • <a target="_blank" href="../../pickers/${ picker }/index.html">${ orthogName } workbench</a> • <a target="_blank" href="${ langTag }_terms.html">Terms list</a> • <a target="_blank" href="${ langTag }-characters.html">Character notes</a> • <a target="_blank" href="../links.html?iso=${ iso }">${ script } links</a> • <a target="_blank" href="../index.html#scriptnotes">Other orthography notes</a></p>
