...
<p>Input is a list of characters (with no spaces), generated by UniView. &nbsp;&nbsp; <label><input type="checkbox" id="sort" checked> Sort first?</label></p>
        ...
        // if this code executes, there is no ipa value, so just print the type info
            ...
            if (first) {
                ...
                if (unikemet[ch]) {
                    ...
                    out += `<table class="unikemet">`
                    if (unikemet[ch].kEH_Cat) out += `<tr><th>kEH_Cat</th><td>${ unikemet[ch].kEH_Cat }</td></tr>`
                    if (unikemet[ch].kEH_Core) out += `<tr><th>kEH_Core</th><td>${ unikemet[ch].kEH_Core }</td></tr>`
                    if (unikemet[ch].kEH_Desc) out += `<tr><th>kEH_Desc</th><td>${ unikemet[ch].kEH_Desc }</td></tr>`
                    if (unikemet[ch].kEH_Func) out += `<tr><th>kEH_Func</th><td>${ unikemet[ch].kEH_Func }</td></tr>`
                    if (unikemet[ch].kEH_FVal) out += `<tr><th>kEH_FVal</th><td>${ unikemet[ch].kEH_FVal }</td></tr>`
                    if (unikemet[ch].kEH_UniK) out += `<tr><th>kEH_UniK</th><td>${ unikemet[ch].kEH_UniK }</td></tr>`
