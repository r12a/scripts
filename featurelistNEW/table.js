...
function resort (column, reverse) { 
	...
	table += '</tr></thead><tbody>'
		...
		for (var i=0;i<items.length;i++) {
            ...
            table += '<td title="Go to Charuse page for '+scriptData[i].id+'"><a href="../../app-charuse/index.html?language='+scriptData[i].id+'" style="font-size:100%;font-weight:bold;" target="_blank">C</td>'
