...
"ccs": `A <a class="termref" target="_blank" href="../glossary/index.html#ccs">CSS (combining character sequence)</a> includes a base (consonant, vowel, or digit) plus all the combining marks plus ZWJ and ZWNJ that are attached to it. When a CCS contains certain characters (such as viramas), multiple CCSs may combine to make a <a class="termref" target="_blank" href="../glossary/index.html#typographicunit">typographic unit</a>, which is a unit of text that is not split during a particular text operation. To simplify usage, this document includes a base with no following characters in the definition of CSS.`,
