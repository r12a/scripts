...
case:N, cursive:Y, mcchars:Y, conjuncts:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"no", justification:"sp str", spacing:"base", gc:Y,
baseline: "romn",
},
...
case:N, cursive:Y, conjuncts:N, mcchars:Y, 
medials:"", finals:"",
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:Y, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"yes", justification:"sp str", spacing:"base", gc:Y,
baseline: "romn",
},
...
type:"alpha", 
voweltype: { inherent:0, letters:Y, marks:N, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:N, circum:N },
case:Y, cursive:N, mcchars:N, conjuncts:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space none",
linebreak:U, hyphen:"yes", justification:U, spacing:U, gc:Y,
baseline: "romn",
},
...
direction: "ltr", rtlnumbers:N,
type:"abug", 
voweltype: { inherent:1, letters:Y, marks:Y, hidden:N, visorder:N, vocalics:Y, ivowels:N, vbase:"HA", vcomposite:N, prebase:Y, circum:Y },
case:N, cursive:N, mcchars:Y, conjuncts:Y, ligs:U,
medials:"", finals:"cm",
clusters: { ligation:Y, stacks:Y, touch:N, conjoined:Y, subjoinedcp:N, visviram:Y, diacritic:N, killer:"v" },
wordsep: "no zwsp",
linebreak:"syllable", hyphen:"yes ᭠", justification:U, spacing:U, gc:N,
baseline: "romn",
},
...
blocks:1, chars:88, bletter:70, bmark:2, bnumber:10, bpunctuation:6, bsymbol:0, bother:569, 
direction: "ltr", rtlnumbers:N,
type:"syll", 
voweltype: { inherent:0, letters:N, marks:N, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:N, circum:N },
case:N, cursive:N, mcchars:N, conjuncts:N, ligs:U, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:U, justification:"sp", spacing:U, gc:Y,
baseline: "romn",
},
...
type:"alpha", 
voweltype: { inherent:0, letters:Y, marks:N, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:N, circum:N },
case: N, cursive:N, mcchars:U, conjuncts:N, ligs:N, 
medials:"", finals:"let",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:U, hyphen:U, justification:U, spacing:U, gc:Y,
...
wordsep: "space",
linebreak:"word", hyphen:"(yes) -", justification:"sp", spacing:U, gc:N,
baseline: "hang",
},
...
direction: "ltr", rtlnumbers:N,
type:"abug", 
voweltype: { inherent:1, letters:N, marks:Y, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:Y, circum:N },
case: N, cursive:N, mcchars:N, conjuncts:N, ligs:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"no", justification:"?", spacing:"?", gc:Y,
baseline: "romn",
},
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"yes -", justification:"sp", spacing:"?", gc:Y,
baseline: "romn",
},
...
medials:"", finals:"cm",
clusters: { ligation:Y, stacks:Y, touch:N, conjoined:Y, subjoinedcp:N, visviram:N, diacritic:N, ligation:Y, killer:"v" },
wordsep: "space",
linebreak:"word", hyphen:"yes -", justification:"sp", spacing:"sp", gc:N,
baseline: "hang",
},
...
type:"alpha", 
voweltype: { inherent:0, letters:Y, marks:N, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:N, circum:N },
case:"allcaps", cursive:N, mcchars:N, conjuncts:N, ligs:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"yes -", justification:"sp", spacing:"sp", gc:Y,
baseline: "romn",
},
...
direction: "ltr", rtlnumbers:N,
type:"alpha", 
voweltype: { inherent:0, letters:Y, marks:"(✓)", hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"", vcomposite:N, prebase:N, circum:N },
...
wordsep: "space",
linebreak:"word", hyphen:"?", justification:"sp", spacing:"?", gc:N,
baseline: "hang",
},
...
direction: "ltr", rtlnumbers:N,
type:"abug", 
voweltype: { inherent:1, letters:Y, marks:Y, hidden:N, visorder:N, vocalics:N, ivowels:Y, vbase:"", vcomposite:N, prebase:Y, circum:N },
case:N, cursive:N, mcchars:Y, conjuncts:Y, ligs:U, 
medials:"", finals:"cm",
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"char word", hyphen:"no", justification:"sp", spacing:"?", gc:Y,
baseline: "ideo",
},
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "no",
linebreak:"char", hyphen:"no", justification:"ic", spacing:"", gc:Y,
baseline: "ideo",
},
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "space",
linebreak:"word", hyphen:"?", justification:"sp", spacing:"sp", gc:Y,
baseline: "romn",
},
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:""},
wordsep:"no",
linebreak:"char", hyphen:"", justification:"ic", spacing:U, gc:Y, baseline:"ideo", 
},
...
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: U,
linebreak:U, hyphen:"n/a", justification:U, spacing:U, gc:Y,
baseline:"romn",
},
...
wordsep:"no",
linebreak:"syllable", hyphen:"", justification:"sp ig", spacing:U, gc:N, baseline:"romn", 
},
...
direction:"ltr", rtlnumbers:N,
voweltype: { inherent:2, letters:Y, marks:Y, hidden:N, visorder:N, vocalics:Y, ivowels:Y, vbase:"QA អ", vcomposite:Y, prebase:Y, circum:Y, },
case:N, cursive:N, mcchars:Y, conjuncts:Y, ligs:N, 
medials:"", finals:"",
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"i"},
wordsep:"no",
...
blocks:1, chars:58, bletter:45, bmark:0, bnumber:10, bpunctuation:0, bsymbol:0, bother:0, 
direction:"ltr", rtlnumbers:N,
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:Y, diacritic:N, killer:""},
wordsep:"space",
linebreak:"word", hyphen:U, justification:"sp", spacing:U, gc:Y, baseline:"romn", 
},
...
direction: "ltr", rtlnumbers:N,
type:"alpha", 
voweltype: { inherent:0, letters:Y, marks:Y, hidden:N, visorder:Y, vocalics:N, ivowels:N, vbase:"O", vcomposite:Y, prebase:Y, circum:N },
case:N, cursive:N, mcchars:Y, conjuncts:N, ligs:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "no",
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:""},
wordsep:"space",
linebreak:"word", hyphen:"", justification:"sp", spacing:Y, gc:Y, baseline:"romn", 
},
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:""},
wordsep:"syllable",
linebreak:"syllable", hyphen:"", justification:U, spacing:U, gc:Y, baseline:"romn", 
},
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:""},
wordsep:"space",
linebreak:"word", hyphen:"", justification:"sp str pad", spacing:U, gc:Y, baseline:"romn", 
},
...
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:Y, killer:""},
wordsep:"space",
linebreak:"word", hyphen:"", justification:"sp str", spacing:U, gc:Y, baseline:"romn", 
},
...
direction:"rtl", rtlnumbers:N,
voweltype: { inherent:0, letters:Y, marks:N, hidden:N, visorder:N, vocalics:N, ivowels:N, vbase:"A 𐴀", vcomposite:N, prebase:N, circum:N, },
case:N, cursive:Y, mcchars:N, conjuncts:N, ligs:N, 
medials:"", finals:"",
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:""},
wordsep:"space",
linebreak:"word", hyphen:"", justification:"str", spacing:U, gc:Y, baseline:"romn", 
},
...
direction:"ltr", rtlnumbers:N,
voweltype: { inherent:1, letters:Y, marks:N, hidden:N, visorder:Y, vocalics:N, ivowels:N, vbase:"", vcomposite:Y, prebase:N, circum:N, },
case:N, cursive:N, mcchars:N, conjuncts:N, ligs:N, 
...
case:N, cursive:N, mcchars:N, conjuncts:Y, ligs:N, 
medials:"", finals:"",
clusters:{ ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:Y, diacritic:N, killer:"v"},
wordsep:"space",
linebreak:"word", hyphen:"", justification:"sp ig", spacing:U, gc:N, baseline:"romn", 
},
...
type:"abug", 
voweltype: { inherent:3, letters:Y, marks:Y, hidden:N, visorder:Y, vocalicase:Y, ivowels:N, vbase:"O", vcomposite:Y, prebase:N, circum:N },
cs: "no", cursive:N, mcchars:Y, conjuncts:N, ligs:N, 
medials:"", finals:"",
clusters: { ligation:N, stacks:N, touch:N, conjoined:N, subjoinedcp:N, visviram:N, diacritic:N, killer:"" },
wordsep: "no",
linebreak:"word", hyphen:U, justification:U, spacing:U, gc:Y,
...
linebreak:"word syllable char", hyphen:"yes<char> (yes)<char> yes{∅} no n/a", justification:"sp ic ig str sw pad none", spacing:"sp base", gc:Y,
